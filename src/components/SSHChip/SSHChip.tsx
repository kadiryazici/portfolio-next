...
export function SSHChip(props: SSHChipProps) {
  ...
  return (
    <button
      ...
      className={cn(
        "max-lg:hidden fixed right-3 bottom-3 z-50 inline-flex h-9 items-center rounded-2xl inset-shadow-liquid border border-white/10 bg-sidebar/50 backdrop-blur-md px-3 font-mono text-[12px] text-ink shadow-[0_10px_28px_rgba(0,0,0,0.3)] transition-colors hover:border-accent/60 hover:text-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent",
        className,
      )}
