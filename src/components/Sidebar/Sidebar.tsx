        ...
        >
          {activeIndex >= 0 && (
            <div
              ...
              className={cn(
                "border inset-shadow-liquid border-transparent pointer-events-none absolute left-0 right-0 mx-auto top-[2px] h-[56px] w-[44px] rounded-full bg-bg-2/100 duration-650 ease-out motion-reduce:transition-none",
