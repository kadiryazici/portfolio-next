        ...
        <div className="relative isolate grid grid-cols-4">
          {activeIndex >= 0 && (
            <div
              ...
              className={cn(
                "pointer-events-none absolute inset-y-0 left-0 w-1/4 rounded-full border border-transparent bg-bg-2 inset-shadow-liquid transition-all duration-650 motion-reduce:transition-none",
