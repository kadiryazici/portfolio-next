...
const edgeStart = PS(U("A2004013000021300000040000201001020062010020000040001040000220020103200200030102030020000"))
const labelStart = PS(U("1168111521111111165<13115664411115333235252313111117115656711111132452113374431215245511"))
const labelText = "abcursordurationfghinsetlemoprstwznimatespectackdrop-blurgluro-coniclinearradialrderttom-bltilterlexontromaprid-cols-yadingftax-bin-txyhw-screenhwbjectpacityriginutline-offsetbtxyioghtngtateunded-rchizealeroll-mtadowrinkextorapckingnsformitionlate-xy"
...
const nodeGroup = U("0000030040460709:;0000@w0000w00000000000N00000000000X000000000a00de00000hj00000000qr00000", 1)
...
const AA = DZ("00000000000000424264>22420026422242242442222404622226622624440444204222")
const AG = DZ("¼2222222222222Õ22204>222º2¹26222222222222222482222262222262ZS222\\Y222")
const AS = DZ("02222222222222221425822;>222222A0DCF22324500820A0000=7Z0YFF222Y\\2222022")
const litAnchor = new Int32Array(363)
const litGroup = new Int32Array(363)
const litPool = new Int32Array(363)
let poolText = ''
const poolOffsets = new Int32Array(402)
{
...
const adjGid = DZ("<2B8626>2>62:2<2HF")
const adjStart = PS(U("::32:2:22:22>22123"))
const adjTgt = DZ("Ĩ22222ĝĠģ2Ĥ22222ĩĬ222}2?³¶222oMuLx\\2¼222ÅÈÍÐ12É5N2222£¦§ª12§1¸22©¬222222222326®222")
const patGid = U("k")
const patTgt = U("I")
