...
const edgeStart = PS(U("B20040130000213000002000400002010010200610020000040001040000220020103200200030102030020000"))
const labelStart = PS(U("11614111521111111165<13115664411114753332357524131117115656711111132452113374431215245511"))
const labelText = "abcursordeasefghinsetlemoprstwznimatespectackdrop-blurgluro-coniclinearradialrderttom-bltelayurationilterlexontromaprid-cols-shadowadingftax-wbin-txy-screenhwbjectpacityriginutline-offsetbtxyioghtngtateunded-rchizealeroll-mtadowrinkextorapckingnsformitionlate-xy"
...
const nodeGroup = U("0000030040460709:;0000000Bx0000x000000000O00000000000Y000000000b00ef00000ik00000000rs00000", 1)
...
const vlistGroup = DZ("000200200202001000040020020020020020020020002020020020202002020020020020020002000200200200020020000020020002000020020020020200202002002002002002002002002000200200200200200200200200200200200020020020020002020202000200020000200")
// nodeVlist rebuilt sparse: (anchor deltas, vlist ids)
const nodeVlist = (() => {
    const out = new Int32Array(90).fill(-1)
    const A = DZ("4242422244222242242224422242222242222422222222262422624224224424222")
    const V = DZ("0222202222222222222222222222222222222222222222222222222222222222222")
...
const AA = DZ("0000000000000000424264>262420026422622244222240462222662262444444204222")
const AG = DZ("¾222222222222222Û22204>2422¼2»2622242222222224822222622222626222`]222")
const AS = DZ("02222222222222222214258222=@222222CFEH2142500820A0000?7\\0[HF22Y\\2222022")
const litAnchor = new Int32Array(358)
const litGroup = new Int32Array(358)
const litPool = new Int32Array(358)
let poolText = ''
const poolOffsets = new Int32Array(426)
{
...
const adjGid = DZ("<2F868<2>62:2<2JH")
const adjStart = PS(U("::32::22:22>22123"))
const adjTgt = DZ("İ22222ĥĨī2Ĭ22222ıĴ2222A22222uMwP>2Â222ËÎÓÖ12Ï5N2 222©¬­°12­1¾22¯²22222222232¡6°222")
const patGid = U("l")
const patTgt = U("K")
